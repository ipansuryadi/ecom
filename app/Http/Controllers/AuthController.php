...
class AuthController extends Controller
{
    ...
    */
    ...
    public function getRegister() {
        ...
        return view('auth.register', compact('query', 'search', 'rand_brands'));
    }
    ...
    public function postRegister(RegistrationRequest $request, AppMailers $mailer) {
        ...
        flash()->overlay('Info', 'Thanks, please login.');
    ...
    public function getLogin() {
        ...
        $search = \DB::table('products')->where('product_name', 'LIKE', '%' . $query . '%')->paginate(10);
$rand_brands = Brand::orderByRaw('RAND()')->take(6)->get();
        return view('auth.login', compact('query', 'search', 'rand_brands'));
    }
