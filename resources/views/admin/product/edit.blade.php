    ...
    <div class="container" id="admin-product-container">
        ...
        <div class="col-md-12">
            ...
            <form role="form" method="POST" action="{{ route('admin.product.update', $product->id) }}">
                ...
                <div class="col-sm-6 col-md-6" id="Product-Input-Field">
                    <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-money green-text fa-2x" aria-hidden="true"></i></div>
                ...
                <div class="col-sm-6 col-md-3" id="Product-Input-Field">
                ...
                <div class="col-sm-3 col-md-3" id="Product-Input-Field">
                    <div class="form-group{{ $errors->has('weight') ? ' has-error' : '' }}">
                        <label>Weight</label>
                        <input type="number" class="form-control" name="weight" value="{{ Request::old('weight') ? : $product->weight }}" placeholder="Edit Product Quantity" min="0">
